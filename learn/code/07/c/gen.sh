...
$GCC -m32 -I lib/kernel/ -I lib/ -I device/  -c -o $BUILD_DIR/kernel/init.o kernel/init.c
$GCC -m32 -I lib/kernel/ -I lib/ -I device/ -c -o $BUILD_DIR/kernel/interrupt.o kernel/interrupt.c
$GCC -m32 -I lib/kernel/ -I lib/ -I device/ -c -o $BUILD_DIR/kernel/timer.o device/timer.c
$GCC -m32 -I lib/kernel/ -I lib/ -I device/ -c -o $BUILD_DIR/kernel/main.o kernel/main.c
...
$LD -melf_i386 -Ttext 0xc0001500 -e main -o $BUILD_DIR/kernel/kernel.bin $BUILD_DIR/kernel/main.o \
  $BUILD_DIR/kernel/init.o $BUILD_DIR/kernel/interrupt.o  $BUILD_DIR/kernel/kernel.o $BUILD_DIR/kernel/timer.o \
